package studio.minekarta.titlemanagerreborn.internal.model.command

import studio.minekarta.titlemanagerreborn.TitleManagerReborn
import studio.minekarta.titlemanagerreborn.internal.commands.TMSubCommand
...
class CommandExecutor(private val plugin: TitleManagerReborn, val cmd: TMSubCommand, val sender: CommandSender, val args: Array<out String>, val parameters: Map<String, CommandParameter>) {
...
internal fun commandExecutor(plugin: TitleManagerReborn, cmd: TMSubCommand, sender: CommandSender, args: Array<out String>, parameters: Map<String, CommandParameter>, init: CommandExecutor.() -> Unit): CommandExecutor {
