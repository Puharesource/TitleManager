...
import studio.minekarta.titlemanagerreborn.internal.extensions.sendConfigMessage
...
class TMCommand constructor(private val plugin: TitleManagerReborn) : CommandExecutor, TabCompleter {
    ...
    private fun createSubCommand(vararg aliases: String, allowedSender: AllowedCommandSender = AllowedCommandSender.ALL, executor: (studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) -> Unit): TMSubCommand {
        val name = aliases.first()
        val otherAliases = aliases.filterIndexed { index, _ -> index != 0 }.toSet()
        val cmdExecutor: (TMSubCommand, CommandSender, Array<out String>, Map<String, CommandParameter>) -> studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor = { cmd, sender, args, parameters ->
    ...
    private fun executorActionbarBroadcast(commandExecutor: studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) {
    ...
    private fun executorActionbarMessage(commandExecutor: studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) {
    ...
    private fun executorAnimations(commandExecutor: studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) {
    ...
    private fun executorBroadcast(commandExecutor: studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) {
        if (commandExecutor.args.isEmpty()) {
            commandExecutor.syntaxError()
            return
        }
    ...
    private fun executorMessage(commandExecutor: studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) {
        if (commandExecutor.args.size <= 1) {
            commandExecutor.syntaxError()
            return
        }
    ...
    private fun executorReload(commandExecutor: studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) {
        plugin.reloadPlugin()
    ...
    private fun executorScoreboard(commandExecutor: studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) {
    ...
    private fun executorScripts(commandExecutor: studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) {
    ...
    private fun executorVersion(commandExecutor: studio.minekarta.titlemanagerreborn.internal.model.command.CommandExecutor) {
