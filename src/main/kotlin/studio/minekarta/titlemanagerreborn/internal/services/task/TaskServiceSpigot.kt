package studio.minekarta.titlemanagerreborn.internal.services.task
...
import studio.minekarta.titlemanagerreborn.internal.info
...
class TaskServiceSpigot @Inject constructor(private val plugin: TitleManagerReborn, private val config: TMConfigMain, private val updateService: UpdateService) : TaskService {
