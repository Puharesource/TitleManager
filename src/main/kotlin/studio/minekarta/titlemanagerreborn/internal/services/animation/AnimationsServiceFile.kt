...
class AnimationsServiceFile @Inject constructor(private val plugin: TitleManagerReborn, private val scriptService: ScriptService, private val placeholderService: PlaceholderService) : AnimationsService {
