package dev.tarkan.titlemanager.nms.legacy.v1_16_R1
...
object LegacyV1_16_R1RuntimeVersionModulePacketSink : LegacyDirectNmsPacketSink {
    ...
    override fun sendActionbar(player: Player, text: String) {
        sendPacket(player, PacketPlayOutChat(component(text), ChatMessageType.GAME_INFO, EMPTY_SENDER))
    }
    ...
    private object PlayerListPacketFields {
        private val headerField = packetField("header")
        private val footerField = packetField("footer")
    ...
    private val EMPTY_SENDER = UUID(0L, 0L)
}
