...
class TaskServiceSpigot @Inject constructor(private val plugin: io.puharesource.mc.titlemanager.TitleManagerPlugin, private val config: TMConfigMain, private val updateService: UpdateService) : TaskService {
