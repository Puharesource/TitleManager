...
class CommandExecutor(private val plugin: io.puharesource.mc.titlemanager.TitleManagerPlugin, val cmd: TMSubCommand, val sender: CommandSender, val args: Array<out String>, val parameters: Map<String, CommandParameter>) {
...
internal fun commandExecutor(plugin: io.puharesource.mc.titlemanager.TitleManagerPlugin, cmd: TMSubCommand, sender: CommandSender, args: Array<out String>, parameters: Map<String, CommandParameter>, init: CommandExecutor.() -> Unit): CommandExecutor {
